...
The Bluetooth LE advertising interval SHOULD be a maximum interval of 2 seconds. If an accessory manufacturer advertises at a less frequent interval, detection performance is diminished.
